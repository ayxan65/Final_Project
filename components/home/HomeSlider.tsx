  ...
  return (
    <div className="bgproducts ">
      <div className=" flex flex-col   items-center ">
        <div className=" text-white text-4xl font-bold my-16 ">Məhsullar</div>
  ...
  <Image src={photo2} alt="img"></Image>
   ...
   <Image src={photo3} alt="img"></Image>
          ...
          <div className="w-4/12 text-white">
            Allow efficient distribution of your telecom and data center power
            utilizing these reliable, scalable and flexible DC power
          </div>
        </div>
      </div>
    </div>
